    ...
    column(3,
      wellPanel(
        ...
        sliderInput("reviews", "Number of reviews on Rotten Tomatoes",
          10, 300, value = c(80, 200), step = 10),
        textInput("earliestYear", "Released after", value=1990),
        textInput("latestYear", "Released before", value=2010),
        ...
        selectInput("rating", "Rating", c("All", "G", "PG", "PG-13", "R", "M"))
      ),
      wellPanel(
